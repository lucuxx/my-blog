...
export default class HomeNav extends Vue {
  ...
  get hostArticle() {
    if (this.$lo.isEmpty(this.allArticleData)) return []
    return this.$util
      .sortKey(this.$lo.cloneDeep(this.allArticleData), 'commentData')
      .slice(0, 5)
  }
