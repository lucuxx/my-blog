      ...
      <div v-for="(item, index) in commentData" :key="index">
          ...
          <div class="list-content">
            ...
            <p style="margin: 10px 0 0 0;font-size: 10px;color: #999">
              ...
              <span
                ...
                class="desc"
                style="color: #37c6c0"
                @click="goReply({ id: item.id, index })"
                >回复</span
              >
              <span
                v-if="isFabulous"
              ...
              >
                ...
                <img
                  ...
                  style="height: 17px;width: 17px;margin-left: 10px;"
                  alt=""
                />
              </span>
            </p>
        ...
        <div class="list">
          ...
          >
            <el-button
              class="slot"
              style="display: inline-block;float: right;margin: 10px 10px 10px 0;"
              slot="button"
              @click="cancelReply"
              >取消回复</el-button
            >
            ...
            <div class="list-content">
              ...
              <p style="margin: 10px 0 0 0;font-size: 10px;color: #999">
                ...
                <span
                  ...
                  style="color: #37c6c0"
                  @click="
                    goCurrentReply({ id: item.id, index: i, data: reply })
                  "
                  >回复</span
                >
              </p>
...
export default class commentList extends Vue {
  ...
  async submitComment() {
    ...
    if (this.$lo.isEmpty(this.userInfo)) {
      ...
      if (this.articleId) {
        ...
        if (this.commentId !== '') {
          params = {
            id: this.commentId,
            reply: this.reply
              ? Object.assign(commentParams, { replyUser: this.reply })
              : commentParams,
          }
          // 如果是添加留言
        } else {
      ...
      const { code, data } = this.articleId
        ...
        : this.commentId !== ''
        ? await this.$api.updateComment(params)
        : await this.$api.addComment(params)
      if (code === 0) {
