<template>
  <section class="card">
    ...
    >
      <div
        style="width: 100%;height: 30%;box-sizing: border-box;line-height: 50px;color: #37c6c0;font-size: 18px;font-weight: 500"
      >
        ...
        <el-col class="col" :span="18">
          ...
          <div class="desc">
            <span class="desc_item"
              ><img class="img" src="../assets/images/fabulous.png" alt="" />{{
                item.fabulousNum
              }}</span
            >
            <span class="desc_item"
